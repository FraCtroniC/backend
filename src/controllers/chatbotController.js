...
2. Usuarios - Tiene 3 pestañas: Estudiantes, Docentes, Administradores. El formulario de creacion/edicion incluye: Primer nombre, Segundo nombre, Primer apellido, Segundo apellido, Fecha de nacimiento, Correo, Tipo de documento (V/E/P), Numero de documento / cedula, Telefono, Username, Contrasena, Carrera (solo para estudiantes), Titulo academico (solo para docentes), Estado, Tipo de registro. Se puede buscar por "Cedula, nombre o correo".
...
5. Periodos - Gestion de periodos academicos. Campos del formulario: Nombre del periodo (ej: 2027-I), Fecha inicio, Fecha fin, Estado de inscripcion (Abierta/Cerrada), Estado del periodo (Planificacion/Activo/Cerrada). Solo puede haber un periodo activo a la vez. Al activar un periodo se notifica a todos los usuarios.

6. Inscripciones - Vista de solo lectura de las inscripciones realizadas. Tabla con: estudiante, carrera, periodo, materias y creditos. Se puede filtrar por carrera.
...
9. Notas - Visualizar y editar notas por seccion. Seleccionas una seccion y ves una tabla con: Cedula, Nombre, Corte 1, Corte 2, Corte 3, Corte 4, Final (promedio automatico), Estado (Cursando/Aprobado/Reprobado). Cada corte se califica de 0 a 20. Hay un boton para "Cerrar Acta" que bloquea la edicion posterior.
...
10. Aspirantes - Gestion de pre-registros. Lista con buscador por "Nombre, cedula, correo o carrera". Filtro por estado: Todos, Pendiente, En Revision, Aprobado, Rechazado. Acciones disponibles: pasar a "En Revision", "Aprobar" (crea automaticamente el usuario y estudiante con credenciales y envia correo), "Rechazar". Tambien se puede eliminar.

11. Historial - Historial academico de estudiantes. Permite buscar por "Cedula o nombre" y muestra materias cursadas, CUM, creditos.
...
3. Estudiantes Inscritos - Primero seleccionas una seccion (materia), luego ves la tabla de estudiantes con: Cedula, Nombre, Corte 1, Corte 2, Corte 3, Corte 4, Promedio (se calcula solo), Estado. Puedes editar los cortes (valor 0-20) y guardar. Tiene botones para exportar: Descargar PDF, Exportar Excel, Imprimir. Puedes buscar estudiantes por nombre o cedula dentro de la seccion.
